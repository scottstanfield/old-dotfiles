...
"    nnoremap <leader>r gq}               " *r*eformat current paragraph
    ...
    nnoremap <leader>p :w<CR>:!./env/bin/python3 % --test <CR>
...
" These three worked for iPython, but not for dumping lines to R
" Possibly too fast for buffer?
...
" Plugins g
	...
	" Same as \fe but this one keeps you in normal mode
	nmap <leader>fe :call SendFunctionToR("echo", "stay")<CR><Esc>

	""""""""""""""""""""

	Plug 'junegunn/goyo.vim'		" :Goyo to enable
...
"R Script settings DELETE THESE
